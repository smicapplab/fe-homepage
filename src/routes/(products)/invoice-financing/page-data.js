// SEO
export const title = 'Koredor Express Invoice Financing';
export const description =
	"Turn your invoices into opportunities! Here's a quick guide on what type of invoice you should submit to guarantee a hassle-free application.";
...
export const ratesTerms = [
	{ label: 'Loan-To-Value Ratio', value: 'Up to 80% of the invoice amount' },
	{ label: 'Minimum-Maximum Financing Amount', value: '₱100,000 - ₱15,000,000' },
	{ label: 'Monthly Interest Rate', value: '2% - 4%' },
