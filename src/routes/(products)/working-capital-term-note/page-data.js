export const title =
	'Working Capital Term Note — flexible, reliable, and designed to fuel long-term success for SMEs!';
...
export const ratesTerms = [
	{
		...
		value: 'Up to 60% of the appraised value of the collateral property'
	},
